    ...
    <template v-else-if="detail">
      ...
      <div class="p-4 bg-white mt-3">
        ...
        <div class="flex items-center gap-2 mt-2">
          ...
          <van-tag v-if="detail.isInsurance" type="success">医保定点</van-tag>
          <van-tag :type="detail.status === 'active' ? 'success' : 'default'">
            {{ detail.status === 'active' ? '营业中' : '已停业' }}
          </van-tag>
        </div>
        ...
        <div class="text-sm text-gray-500 mt-3">
          ...
          <div class="flex items-center gap-2 py-2 border-b">
            <van-icon name="clock" />
            <span>{{ detail.businessHours || '请咨询' }}</span>
          </div>
      ...
      <!-- 机构设施 -->
      <div class="p-4 bg-white mt-3" v-if="detail.facilities && detail.facilities.length > 0">
        <h3 class="font-semibold mb-2">机构设施</h3>
        <div class="flex flex-wrap gap-2">
          <van-tag
      ...
      <!-- 医生团队 -->
      <div class="p-4 bg-white mt-3" v-if="detail.doctors && detail.doctors.length > 0">
        <h3 class="font-semibold mb-2">医生团队</h3>
        <van-cell-group>
          <van-cell
